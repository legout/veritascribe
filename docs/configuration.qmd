...
info = dspy_config.get_provider_info()
print('Configuration loaded successfully')
print(f'Provider: {info["provider_name"]}')
print(f'Model: {info["formatted_model"]}')
...
cp .env .env.quality
echo "DEFAULT_MODEL=gpt-4" >> .env.quality
echo "MAX_TOKENS=3000" >> .env.quality

# Fast analysis  
cp .env .env.fast
echo "DEFAULT_MODEL=gpt-3.5-turbo" >> .env.fast
echo "PARALLEL_PROCESSING=true" >> .env.fast

# Cost-optimized analysis
cp .env .env.budget
echo "LLM_PROVIDER=openrouter" >> .env.budget
echo "DEFAULT_MODEL=z-ai/glm-4.5-air:free" >> .env.budget
```
